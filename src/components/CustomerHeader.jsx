        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-2">
              {/* Ganti bagian ini: */}
              <img
                src="/images/logo.png" // Sesuaikan path/nama file gambar Anda
                alt="Logo Lemari Lama"
                className="w-20 h-20 object-cover " // `rounded-full` bisa dihapus jika ingin bentuk persegi
              />
              <h1 className="text-2xl font-bold text-black">Lemari Lama</h1>
            </div>
        ...
        {isMenuOpen && (
          <div className="lg:hidden border-t border-gray-200">
            <div className="px-4 pt-2 pb-3 space-y-1 bg-white">
              ...
              <a
                href="#"
                className="block px-3 py-2 text-gray-700 hover:text-black font-medium"
              >
                Shop
              </a>
              <a
                href="#"
                className="block px-3 py-2 text-blue-500 hover:text-blue-600 font-medium"
              >
                On Sale
              </a>
              <a
